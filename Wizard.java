...
/**
 * Represents a Wizard character, a subclass of Character
 * 
 * @author williamyao
 */
public class Wizard extends Character {
    /**
     * new Wizard(): String -> void
     ...
     * Example: new Wizard("William") initializes all fields 
     ...
     * Example: new Wizard("William", 1, 1, 1, 1, 1) initializes name to
    ...
    public void attack(Character c) {
        ...
        double raw = (r1 - 4) / 8.0 * (super.getDexterity() 
                     + super.getIntelligence() + super.getLevel());
    ...
    /**
     * multiAttack(): Character[] -> void
     * Description: consumes a Character array, and attacks all of the objects 
     *              in the array with the object that calls this method
     * Example: attack(eFight) attacks all objects in the eFight array
     * @param c Character array to be attacked
     */
    public void multiAttack(Character[] c) {
        ...
        for (Character target: c) {
            ...
            double raw = r1 / 6.0 * (super.getDexterity() + super.getWisdom()
                         + super.getLevel());
            int attack = (int)Math.floor(Math.abs(raw));
     ...
     *              original strength + 1, dexterity to original dexterity + 1
     *              intelligence to original intelligence + 2, and wisdom
     ...
     * Example: toString() -> Level 1 wiard named William with 6 strength, 
