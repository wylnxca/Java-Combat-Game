...
public class Cleric extends Character{
     ...
     * Example: new Cleric("William") initializes all fields 
     ...
     * Example: new Cleric("William", 1, 1, 1, 1, 1) initializes name to
    ...
    public void attack(Character c) {
        ...
        double raw = (r1 + r2 - 6) / 6.0 * (super.getStrength() 
                     + super.getDexterity() + super.getLevel()) + 2;
    ...
    public void heal(Character c) {
        ...
        double raw = (r1 + super.getWisdom() - 2) / 2.0;
     ...
     * Example: toString() -> Level 1 cleric named William with 6 strength, 
